...
router.post("/updateDisorderIsActive/:id", verifyTokenAdmin, updateDisorderIsActive);
...
router.get('/listDisordersBySpeciality/:speciality_id', listDisordersBySpeciality);
